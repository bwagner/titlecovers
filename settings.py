...
# Django settings for titlecovers project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'titlecovers.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '42#!4im3^z(y6$!aih^v1qz)1w*evdvpr!!t-)i*bbysgv30d_'
